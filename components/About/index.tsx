...
const About = () => {
  ...
  const content = {
    ...
    ar: {
      ...
      description:"شركة سور الطريق هي موزع رائد للأدوية بالجملة، حيث تقدم أدوية عالية الجودة وبأسعار معقولة للمستشفيات الحكومية. مهمتنا هي ضمان توفير الأدوية الأساسية بشكل موثوق وفي الوقت المحدد ورعاية المرضى المتفانين. نحن ملتزمون بتجاوز التوقعات وبناء علاقات قوية وطويلة الأمد مع عملائنا.",
      knowMore: "اعرف أكثر",
    },
  };
